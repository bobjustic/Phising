...
<font color="#000080"><b>Subject</b></font>	<input type=text name=t2 size="38">
	...
	<div>
<div style="position: absolute; width: 100px; height: 100px; z-index: 2; left: 103px; top: 240px" id="layer8">
<pre><font color="#000080"><b>Message</b></font>
	<textarea cols=35 rows=10 name="t3"></textarea></pre></div>
</div>

<div style="position: absolute; width: 69px; height: 38px; z-index: 4; left: 251px; top: 439px" id="layer10">
<input type=button name=b style="width: 70; height: 19; border-style: solid; border-width: 0; background-image: url('image/sendmail.gif')" onclick="composeClick()">
</div>
