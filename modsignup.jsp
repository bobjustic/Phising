...
<blockquote>
	...
	<form method=post>		<blockquote>
				<blockquote>
					<blockquote>
						<pre><b><font color="#000080">Name</font></b>		   <font color="#008081"><input type=text name=p1 value="<%=request.getAttribute("name").toString()%>" readonly ></font><br>
<b><font color="#000080">UserName</font></b>	   <input type=text name=p2><br>
<b><font color="#000080">Password</font></b>	   <input type=password name=p31 value="<%=request.getAttribute("pwd").toString()%>" readonly><br>
<b><font color="#000080">ReTypePassword </font></b>    <input type=password name=p32 value="<%=request.getAttribute("pwd").toString()%>" readonly><br>
<b><font color="#000080">Secret Question</font>	</b>   <input type=text name=p4 value="<%=request.getAttribute("secq").toString()%>" size="30" readonly><br>

<b><font color="#000080">Secret Answer</font></b>	   <input type=text name=p5 value="<%=request.getAttribute("seca").toString()%>" readonly><br>
