...
<% String fr=mf.from; %>
		...
		<div style="position: absolute; width: 71px; height: 28px; z-index: 1; left: 707px; top: -30px" id="layer9">
<input type=button name=b onclick="backk()" style="font-family: Lucida Calligraphy; font-weight: bold; width: 70; height: 27; border: 1px solid #FFFFFF; background-image: url('image/pre.gif')"></div>
	...
	<tr>
		...
		<td height="36"  background="image/b11.jpg"><font color="#000080"><%=status[s]%></font></td>
	</tr>
	<tr>
		...
		<td height="33"  background="image/b11.jpg"><font color="#000080"><%=mf.msg%></font></td>
	</tr>
</table></center></div>
</div> 
</form>
